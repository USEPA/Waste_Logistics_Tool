...
print("...");
print("... Warning this test script consumes a small number of AGO credits");
print("...");
...
print("  inject waste type of Municipal Solid Waste (MSW)");
print("  inject waste medium of Volume Solid");
print("  inject waste unit of m3");
print("  inject waste amount of 500000");
parameters[3].value = 'Municipal Solid Waste (MSW)';
parameters[4].value = 'Volume Solid';
parameters[5].value = 'm3';
parameters[6].value = 500000;
...
###############################################################################
print("Step 150: Setting LoadFacilitiesToNetwork parameters."); 
...
###############################################################################
print("Step 160: Executing gp_LoadFacilitiesToNetwork.");
messages = None;
rez = ah.execute(parameters,messages);

###############################################################################
# Step 170
# Draw routing barrier
###############################################################################
print("Step 170: Draw a routing barrier.");
...
###############################################################################
print("Step 180: Setting SolveRoutingScenario parameters."); 
...
print("  inject numberoffacilitiestofind to be 2");
...
###############################################################################
print("Step 190: Executing gp_SolveRoutingScenario.");
messages = None;
rez = ah.execute(parameters,messages);
...
###############################################################################
print("Step 200: Setting CalculateLogisticsPlanningEstimates parameters."); 
...
###############################################################################
print("Step 210: Executing gp_CalculateLogisticsPlanningEstimates.");
messages = None;
rez = ah.execute(parameters,messages);
...
###############################################################################
print("Step 220: Setting ExportLogisticsPlanningResults parameters."); 
...
###############################################################################
print("Step 230: Executing gp_ExportLogisticsPlanningResults.");
messages = None;
rez = ah.execute(parameters,messages);
